...
This project is a task-tracker SaaS app built using **HTML5**, **CSS3**, **Boostrap5**, **jQuery** and modern web design principles. It’s designed to be **responsive**, **clean**, and **user-friendly**, giving visitors a high-level view of my development skills to build a SaaS website.
